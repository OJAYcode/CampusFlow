  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-44 min-w-0 flex-col bg-sidebar text-sidebar-foreground",
            className
          )}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-44 bg-transparent transition-[width] duration-200 ease-linear",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-44 transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
